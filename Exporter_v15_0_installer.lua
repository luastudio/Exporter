-- Exporter v15_0 installer
-- https://github.com/luastudio/Exporter/releases/download/15.0/Exporter_v15_0.luastudio

host = "github.com"
path = "/luastudio/Exporter/releases/download/15.0/"
fileName = "Exporter_v15_0.luastudio"
