-- Exporter v14_0 installer
-- https://github.com/luastudio/Exporter/releases/download/14.0/Exporter_v14_0.luastudio

host = "github.com"
path = "/luastudio/Exporter/releases/download/14.0/"
fileName = "Exporter_v14_0.luastudio"
