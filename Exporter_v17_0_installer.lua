-- Exporter v17_0 installer
-- https://github.com/luastudio/Exporter/releases/download/17.0/Exporter_v17_0.luastudio

host = "github.com"
path = "/luastudio/Exporter/releases/download/17.0/"
fileName = "Exporter_v17_0.luastudio"
